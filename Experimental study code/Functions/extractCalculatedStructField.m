% Extracts an appropriate slice of a squeezed set of dimensions, taking
% into account the fact that singleton dimensions are dropped. Enter 0 for
% dimensions that you want to obtain all of
% Nominal inds should be expressed in the order [spindleSpeed, radialWidth,
% axialDepth, feedPerFlute, cutDirection]. Any 
function rArr = extractCalculatedStructField(samples, fieldName, nominalInds, opts)
    arguments
        samples
        fieldName string
        nominalInds
